...
function getRecibos(){
    ...
    ajax("http://localhost/cobro3/cobdes_id_dinamico/", "POST", "txt", setRecibos, formData);
}
...
function submit(event){
    ...
    ajax("../cobdes_id_dinamico/", "POST", "txt", setRecibos, formData);
}
...
function botonCobrarClick(){
    botonCobrar.addEventListener("click", function() {
        ...
        ajax("../cobdes_id_dinamico/", "POST", "nada", getRecibos, formData);
    });
}
